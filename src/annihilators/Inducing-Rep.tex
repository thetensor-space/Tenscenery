...
\begin{frame}[fragile]
    \begin{tikzcd}
        K[x_0] \times \cdots\times K[x_{\vav}]
            \arrow[dd,xshift=-6ex,"\rho_0"]
            \arrow[dd,xshift=6ex, "\rho_{\vav}"]
            \arrow[r,tail]
            \only<2->{\arrow[r,tail]}
                & K[x_0]\otimes\cdots\otimes K[x_{\vav}]
                    \only<1>{\arrow[dd,"\rho_0\otimes\cdots\otimes\rho_{\vav}"]}
                    \only<2->{\arrow[d,"\cong"]}\\
            & 
              \only<2->{
                K[x_0,\ldots,x_{\vav}]
              ...
              \\
        \mathrm{End}(V_0)\times\cdots\times \mathrm{End}(V_{\vav})
            \arrow[r,tail] 
            & \mathrm{End}(V_0)\otimes\cdots\otimes\mathrm{End}(V_{\vav})
                \only<2->{\arrow[d]}\\
        & 
              \only<2>{
                \mathrm{End}(V_0\oslash\cdots\oslash V_{\vav})
              }
    \end{tikzcd}
\end{frame}
