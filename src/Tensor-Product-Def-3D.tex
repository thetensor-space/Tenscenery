...
%\begin{center}
\begin{tikzpicture}
    \fill[color=white] (-1,-1) rectangle (5,3);
    \foreach \x/\val in {0/1,1/2,2/3,3/4} 
        {\pic at (\x,0,3) {rwing={1/1/1/{\small $u_{\val}$}}};}
    %\pause
    \foreach \y/\val in {0/1,1/2,2/3}
        {\pic at (-1,\y,3) {mwing={1/1/1/{\small $v_{\val}$}}};}
    %\pause    
    \foreach \z/\val in {0/1,1/2} 
        {\pic at (0,3,1+\z) {lwing={1/1/1/{\small $w_{\val}$}}};}
    \pause 
    \foreach \x/\valx in {0/1,1/2,2/3,3/4} {
        \foreach \y/\valy in {0/1,1/2,2/3} {
            \foreach \z/\valz in {0/1,1/2} { 
                \pic at (\x,\y,1+\z) {cube={1/1/1/{\tiny $u_{\valy}v_{\valx}w_{\valz}$}}};
                \pause
            };
        }
    }
