...
\begin{tikzpicture}
    \foreach \x in {1, ...,4} {
        \pic at (\x,0,0) {mwing={1/1/1/{\small $u_{\x}$}}};
        \pic at (\x,0,0) {rwing={1/1/1/{\small $w_{\x}$}}};
    }
    \pause
    \fill[color=white] (-1,-1) rectangle (5,1.5);
    \foreach \x in {1, ...,4} {
        \pic at (\x,0,0) {mwing={1/1/1/{\small $u_{\x}w_{\x}$}}};
    }
    \foreach \n in {2,...,4} {
        \pause
        \fill[color=white] (-1,-1) rectangle (5,1.5);
        ...
        \draw[->,thick] (\n,-0.5) -- (5,-0.5);
        %
        \pic at (\n,0,0) {mwing={1/1/1/{\tiny $\overset{\n}{\underset{i=1}{\Sigma}} u_{i}w_i$}}};
    }
\end{tikzpicture}
%\end{center}
\end{frame}
